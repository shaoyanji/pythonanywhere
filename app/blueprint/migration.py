...
@app.route("/wasm/kc", methods=["GET", "POST"])
def kccccc():
...
# async doesnt work with datastar async issues
@app.route("/datastar", methods=["GET", "POST"])
def datastar():
    return render_template(
        "index4.html", messages=messages, navigation=navigation2, svg=svg, style=style
    )    

# akiworks
@app.route("/aki", methods=["GET", "POST"])
def aki():
    return render_template(
        "index5.html", messages=messages, navigation=navigation2, svg=svg, style=style
    )


# htmz works
@app.route("/htmz", methods=["GET", "POST"])
def htmz():
    return render_template(
...
def alt():
    return render_template(
        "index3.html", messages=messages, navigation=navigation2, svg=svg, style=style
    )
